...
public class About {
    public static String table = "about";
    ...
    public About(String id, String title, String content) {
        this.id = id;
        this.title = title;
    ...
    public About(JSONObject about){
        try{
            if(about.has("id")){
                this.id = about.getString("id");
            }

            if(about.has("title")){
                this.title = about.getString("title");
            }

            if(about.has("content")){
                this.content = about.getString("content");
            }
    ...
    public static About convertToClass(ArrayList<String> object){
        String id = object.get(0);
        String title = object.get(1);
        String content = object.get(2);

        About about = new About(id, title, content);
